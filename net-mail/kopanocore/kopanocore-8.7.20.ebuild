...
SRC_URI_TAG="kopanocore-8.7.20"

SRC_URI="https://stash.kopano.io/rest/api/latest/projects/KC/repos/kopanocore/archive?at=refs%2Ftags%2F${P}&format=tar.gz -> ${P}.tar.gz"
